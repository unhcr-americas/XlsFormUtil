...
# remotes::install_github('unhcr-americas/XlsFormUtil')  
...
xlsformpath <- here::here( params$xlsformfile)
...
This document was automatically generated from the encoded version of the questionnaire in XlsForm using the  [{XlsFormUtil} package](https://unhcr-americas.github.io/XlsFormUtil/). It is designed to ease the final steps in the questionnaire design process in order to avoid juggling between the encoded and printed versions. Below is an estimation of the duration time for the questionnaire:
 

```{r single-bar, echo=FALSE, message=FALSE, warning=FALSE   }
if( params$estimation == TRUE) {

p <- fct_interview_duration(xlsformpath, 
...
fct_create_flextable(xlsformpath = xlsformpath, 
